...
class rtl_sdr_receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Rtl Sdr Receiver")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rtl Sdr Receiver")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rtl_sdr_receiver")
        ...
        self.fsk_deviation_hz = fsk_deviation_hz = 170
        self.BladeRF_freq = BladeRF_freq = 902e6
        ...
        self.osmosdr_source_0.set_center_freq(2.49e9, 0)
        self.osmosdr_source_0.set_freq_corr(0, 0)
        self.osmosdr_source_0.set_gain(30, 0)
        self.osmosdr_source_0.set_if_gain(0, 0)
        self.osmosdr_source_0.set_bb_gain(20, 0)
        self.osmosdr_source_0.set_antenna('', 0)
        self.osmosdr_source_0.set_bandwidth(250000, 0)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(5, firdes.low_pass(1.0,samp_rate,40000,10000), 80e3, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1.0,self.samp_rate,40000,10000))
    ...
    def get_BladeRF_freq(self):
        return self.BladeRF_freq

    def set_BladeRF_freq(self, BladeRF_freq):
        self.BladeRF_freq = BladeRF_freq



def main(top_block_cls=rtl_sdr_receiver, options=None):
