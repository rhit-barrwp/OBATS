...
# Title: Newtx
# Generated: Thu Jan 28 14:49:55 2021
##################################################
...
class NewTx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Newtx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Newtx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "NewTx")
...
def main(top_block_cls=NewTx, options=None):
